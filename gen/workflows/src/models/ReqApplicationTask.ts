...
import {
    ...
    EnumTaskTypeToJSON,
    ReqApplicationTaskAllOf,
    ReqApplicationTaskAllOfFromJSON,
    ReqApplicationTaskAllOfFromJSONTyped,
    ReqApplicationTaskAllOfToJSON,
    ReqBaseTask,
    ReqBaseTaskFromJSON,
 ...
 * 
 * @export
 * @interface ReqApplicationTask
 */
export interface ReqApplicationTask {
    /**
     * 
     * @type {string}
...
export function ReqApplicationTaskFromJSON(json: any): ReqApplicationTask {
    return ReqApplicationTaskFromJSONTyped(json, false);
}

export function ReqApplicationTaskFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReqApplicationTask {
...
export function ReqApplicationTaskToJSON(value?: ReqApplicationTask | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
