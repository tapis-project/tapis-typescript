...
export class SitesApi extends runtime.BaseAPI {
     ...
     * Update a site
     */
    async updateSiteRaw(requestParameters: UpdateSiteRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<RespUpdateSite>> {
        if (requestParameters.projectId === null || requestParameters.projectId === undefined) {
     ...
     * Update a site
     */
    async updateSite(requestParameters: UpdateSiteRequest, initOverrides?: RequestInit): Promise<RespUpdateSite> {
