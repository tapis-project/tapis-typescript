...
/**
 * Check if a given object implements the NewSnapshot interface.
 */
export function instanceOfNewSnapshot(value: object): value is NewSnapshot {
...
export function NewSnapshotToJSON(json: any): NewSnapshot {
    return NewSnapshotToJSONTyped(json, false);
}

export function NewSnapshotToJSONTyped(value?: NewSnapshot | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
