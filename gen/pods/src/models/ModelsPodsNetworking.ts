...
export function ModelsPodsNetworkingFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelsPodsNetworking {
    ...
    return {
        ...
        'tapis_auth_return_path': !exists(json, 'tapis_auth_return_path') ? undefined : json['tapis_auth_return_path'],
        'cors_allow_origins': !exists(json, 'cors_allow_origins') ? undefined : json['cors_allow_origins'],
        'cors_allow_methods': !exists(json, 'cors_allow_methods') ? undefined : json['cors_allow_methods'],
        'cors_allow_headers': !exists(json, 'cors_allow_headers') ? undefined : json['cors_allow_headers'],
        'cors_allow_credentials': !exists(json, 'cors_allow_credentials') ? undefined : json['cors_allow_credentials'],
        'cors_max_age': !exists(json, 'cors_max_age') ? undefined : json['cors_max_age'],
