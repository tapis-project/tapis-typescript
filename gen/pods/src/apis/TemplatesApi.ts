...
export class TemplatesApi extends runtime.BaseAPI {
     ...
     * list_templates
     */
    async listTemplatesRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TemplatesResponse>> {
        const queryParameters: any = {};
     ...
     * list_templates
     */
    async listTemplates(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TemplatesResponse> {
