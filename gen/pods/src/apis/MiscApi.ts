...
export class MiscApi extends runtime.BaseAPI {
     ...
     * error_handler
     */
    async errorHandlerRaw(requestParameters: ErrorHandlerRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['status'] == null) {
            throw new runtime.RequiredError(
                'status',
                'Required parameter "status" was null or undefined when calling errorHandler().'
            );
        }
     ...
     * error_handler
     */
    async errorHandler(requestParameters: ErrorHandlerRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
     ...
     * traefik_config
     */
    async traefikConfigRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        const queryParameters: any = {};
     ...
     * traefik_config
     */
    async traefikConfig(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
