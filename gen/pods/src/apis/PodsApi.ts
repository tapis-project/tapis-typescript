...
export interface DownloadFromPodRequest {
    podId: string;
    urlPath: string;
    path?: string;
}
...
export interface ListFilesInPodRequest {
    podId: string;
    urlPath: string;
    path?: string;
}
...
export class PodsApi extends runtime.BaseAPI {
     ...
     * create_pod
     */
    async createPodRaw(requestParameters: CreatePodRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PodResponse>> {
        if (requestParameters['newPod'] == null) {
            throw new runtime.RequiredError(
                'newPod',
                'Required parameter "newPod" was null or undefined when calling createPod().'
            );
        }
     ...
     * create_pod
     */
    async createPod(requestParameters: CreatePodRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PodResponse> {
     ...
     * delete_pod
     */
    async deletePodRaw(requestParameters: DeletePodRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PodDeleteResponse>> {
        if (requestParameters['podId'] == null) {
            throw new runtime.RequiredError(
                'podId',
                'Required parameter "podId" was null or undefined when calling deletePod().'
            );
        }
     ...
     * delete_pod
     */
    async deletePod(requestParameters: DeletePodRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PodDeleteResponse> {
     ...
     */
    async downloadFromPodRaw(requestParameters: DownloadFromPodRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['podId'] == null) {
            throw new runtime.RequiredError(
                'podId',
                'Required parameter "podId" was null or undefined when calling downloadFromPod().'
            );
        }
        ...
        if (requestParameters['urlPath'] == null) {
            throw new runtime.RequiredError(
                'urlPath',
                'Required parameter "urlPath" was null or undefined when calling downloadFromPod().'
            );
        }
        ...
        const response = await this.request({
            path: `/v3/pods/{pod_id}/download_from_pod{url_path}`.replace(`{${"pod_id"}}`, encodeURIComponent(String(requestParameters['podId']))).replace(`{${"url_path"}}`, encodeURIComponent(String(requestParameters['urlPath']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Download a file from the pod\'s filesystem
     */
    async downloadFromPod(requestParameters: DownloadFromPodRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.downloadFromPodRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * exec_pod_commands
     */
    async execPodCommandsRaw(requestParameters: ExecPodCommandsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['podId'] == null) {
            throw new runtime.RequiredError(
                'podId',
                'Required parameter "podId" was null or undefined when calling execPodCommands().'
            );
        }

        if (requestParameters['executePodCommands'] == null) {
            throw new runtime.RequiredError(
                'executePodCommands',
                'Required parameter "executePodCommands" was null or undefined when calling execPodCommands().'
            );
        }
     ...
     * exec_pod_commands
     */
    async execPodCommands(requestParameters: ExecPodCommandsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
     ...
     * get_derived_pod
     */
    async getDerivedPodRaw(requestParameters: GetDerivedPodRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PodResponse>> {
        if (requestParameters['podId'] == null) {
            throw new runtime.RequiredError(
                'podId',
                'Required parameter "podId" was null or undefined when calling getDerivedPod().'
            );
        }
        ...
        if (requestParameters['resolveSecrets'] != null) {
            queryParameters['resolve_secrets'] = requestParameters['resolveSecrets'];
        }
     ...
     * get_derived_pod
     */
    async getDerivedPod(requestParameters: GetDerivedPodRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PodResponse> {
     ...
     * get_pod
     */
    async getPodRaw(requestParameters: GetPodRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PodResponse>> {
        if (requestParameters['podId'] == null) {
            throw new runtime.RequiredError(
                'podId',
                'Required parameter "podId" was null or undefined when calling getPod().'
            );
        }
        ...
        if (requestParameters['checkUnresolved'] != null) {
            queryParameters['check_unresolved'] = requestParameters['checkUnresolved'];
        }
     ...
     * get_pod
     */
    async getPod(requestParameters: GetPodRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PodResponse> {
     ...
     * get_pod_credentials
     */
    async getPodCredentialsRaw(requestParameters: GetPodCredentialsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PodCredentialsResponse>> {
        if (requestParameters['podId'] == null) {
            throw new runtime.RequiredError(
                'podId',
                'Required parameter "podId" was null or undefined when calling getPodCredentials().'
            );
        }
     ...
     * get_pod_credentials
     */
    async getPodCredentials(requestParameters: GetPodCredentialsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PodCredentialsResponse> {
     ...
     * get_pod_logs
     */
    async getPodLogsRaw(requestParameters: GetPodLogsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PodLogsResponse>> {
        if (requestParameters['podId'] == null) {
            throw new runtime.RequiredError(
                'podId',
                'Required parameter "podId" was null or undefined when calling getPodLogs().'
            );
        }
     ...
     * get_pod_logs
     */
    async getPodLogs(requestParameters: GetPodLogsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PodLogsResponse> {
     ...
     */
    async listFilesInPodRaw(requestParameters: ListFilesInPodRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['podId'] == null) {
            throw new runtime.RequiredError(
                'podId',
                'Required parameter "podId" was null or undefined when calling listFilesInPod().'
            );
        }
        ...
        if (requestParameters['urlPath'] == null) {
            throw new runtime.RequiredError(
                'urlPath',
                'Required parameter "urlPath" was null or undefined when calling listFilesInPod().'
            );
        }
        ...
        const response = await this.request({
            path: `/v3/pods/{pod_id}/list_files{url_path}`.replace(`{${"pod_id"}}`, encodeURIComponent(String(requestParameters['podId']))).replace(`{${"url_path"}}`, encodeURIComponent(String(requestParameters['urlPath']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * List files in the pod\'s filesystem
     */
    async listFilesInPod(requestParameters: ListFilesInPodRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.listFilesInPodRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * pod_auth
     */
    async podAuthRaw(requestParameters: PodAuthRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PodResponse>> {
        if (requestParameters['podIdNet'] == null) {
            throw new runtime.RequiredError(
                'podIdNet',
                'Required parameter "podIdNet" was null or undefined when calling podAuth().'
            );
        }
     ...
     * pod_auth
     */
    async podAuth(requestParameters: PodAuthRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PodResponse> {
     ...
     * pod_auth_callback
     */
    async podAuthCallbackRaw(requestParameters: PodAuthCallbackRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PodResponse>> {
        if (requestParameters['podIdNet'] == null) {
            throw new runtime.RequiredError(
                'podIdNet',
                'Required parameter "podIdNet" was null or undefined when calling podAuthCallback().'
            );
        }
     ...
     * pod_auth_callback
     */
    async podAuthCallback(requestParameters: PodAuthCallbackRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PodResponse> {
     ...
     * restart_pod
     */
    async restartPodRaw(requestParameters: RestartPodRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PodResponse>> {
        if (requestParameters['podId'] == null) {
            throw new runtime.RequiredError(
                'podId',
                'Required parameter "podId" was null or undefined when calling restartPod().'
            );
        }

        const queryParameters: any = {};

        if (requestParameters['grabLatestTemplateTag'] != null) {
     ...
     * restart_pod
     */
    async restartPod(requestParameters: RestartPodRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PodResponse> {
     ...
     */
    async savePodAsTemplateTagRaw(requestParameters: SavePodAsTemplateTagRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TemplateTagResponse>> {
        if (requestParameters['podIdNet'] == null) {
            throw new runtime.RequiredError(
                'podIdNet',
                'Required parameter "podIdNet" was null or undefined when calling savePodAsTemplateTag().'
            );
        }

        if (requestParameters['newTemplateTagFromPod'] == null) {
            throw new runtime.RequiredError(
                'newTemplateTagFromPod',
                'Required parameter "newTemplateTagFromPod" was null or undefined when calling savePodAsTemplateTag().'
            );
        }
     ...
     * save_pod_as_template_tag
     */
    async savePodAsTemplateTag(requestParameters: SavePodAsTemplateTagRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TemplateTagResponse> {
     ...
     * start_pod
     */
    async startPodRaw(requestParameters: StartPodRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PodResponse>> {
        if (requestParameters['podId'] == null) {
            throw new runtime.RequiredError(
                'podId',
                'Required parameter "podId" was null or undefined when calling startPod().'
            );
        }
     ...
     * start_pod
     */
    async startPod(requestParameters: StartPodRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PodResponse> {
     ...
     * stop_pod
     */
    async stopPodRaw(requestParameters: StopPodRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PodResponse>> {
        if (requestParameters['podId'] == null) {
            throw new runtime.RequiredError(
                'podId',
                'Required parameter "podId" was null or undefined when calling stopPod().'
            );
        }
     ...
     * stop_pod
     */
    async stopPod(requestParameters: StopPodRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PodResponse> {
     ...
     * update_pod
     */
    async updatePodRaw(requestParameters: UpdatePodRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PodResponse>> {
        if (requestParameters['podId'] == null) {
            throw new runtime.RequiredError(
                'podId',
                'Required parameter "podId" was null or undefined when calling updatePod().'
            );
        }

        if (requestParameters['updatePod'] == null) {
            throw new runtime.RequiredError(
                'updatePod',
                'Required parameter "updatePod" was null or undefined when calling updatePod().'
            );
        }
     ...
     * update_pod
     */
    async updatePod(requestParameters: UpdatePodRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PodResponse> {
     ...
     */
    async uploadToPodRaw(requestParameters: UploadToPodRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['podId'] == null) {
            throw new runtime.RequiredError(
                'podId',
                'Required parameter "podId" was null or undefined when calling uploadToPod().'
            );
        }
        ...
        if (requestParameters['file'] == null) {
            throw new runtime.RequiredError(
                'file',
                'Required parameter "file" was null or undefined when calling uploadToPod().'
            );
        }

        if (requestParameters['destPath'] == null) {
            throw new runtime.RequiredError(
                'destPath',
                'Required parameter "destPath" was null or undefined when calling uploadToPod().'
            );
        }
     ...
     * Upload a file directly into the pod\'s filesystem
     */
    async uploadToPod(requestParameters: UploadToPodRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
