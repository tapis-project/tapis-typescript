...
export class WorkersApi extends runtime.BaseAPI {
     ...
     */
    async manageWorkerPoolSizeRaw(requestParameters: ManageWorkerPoolSizeRequest): Promise<runtime.ApiResponse<BasicResponse>> {
        if (requestParameters.actorId === null || requestParameters.actorId === undefined) {
     ...
     * manageWorkerPoolSize
     */
    async manageWorkerPoolSize(requestParameters: ManageWorkerPoolSizeRequest): Promise<BasicResponse> {
